        ...
        <div class="main-panel">
            <div class="main-content">
                <div class="content-wrapper"><!--Statistics cards Starts-->
                    ...
                    <a href="orderbyapp.php" ><button id="app" type="button" class="active btn btn-bitbucket">App Orders</button></a>
                                        ...
                                        <table class="table table-striped" id="example">
                                            ...
                                            <tbody>
                                                ...
                                                if($username == 'admin' || $check_menu_order['view_g'] ==1){
                                                    $sel = $con->query("select * from orders where status ='completed' and order_type ='app' order by id desc");
                                                }else{
                                                    $sel = $con->query("select * from orders where status ='completed' and order_type ='app' and created_by =".$admin_id." order by id desc");
                                                }
