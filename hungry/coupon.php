...
<?php if(isset($_GET['edit'])) {
			if($username != 'admin' && $check_menu_coupon['edit'] !=1 ){
				?>
				<script>
...
$con->query("update tbl_coupon set c_title='".$ccode."',c_img='".$url."',min_amt=".$minamt.",ctitle='".$ctitle."',cdate='".$cdate."',c_value=".$cvalue.",status=".$cstatus.",c_desc='".$cdesc."',created_by='".$admin_id."' where id=".$_GET['edit']."");
 
}
else 
{
    $con->query("update tbl_coupon set c_title='".$ccode."',ctitle='".$ctitle."',min_amt=".$minamt.",cdate='".$cdate."',c_value=".$cvalue.",status=".$cstatus.",c_desc='".$cdesc."',created_by='".$admin_id."' where id=".$_GET['edit']."");
}
?>
...
<?php } else { if($username != 'admin' && $check_menu_coupon['create'] !=1 ){?>
						<script>
							window.location.href="404.php";
						</script>
					<?php	}	?>
...
<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
        ...
        $url = $uploadPath."thump_".$resizeFileName.".". $fileExt;
$con->query("insert into tbl_coupon(`c_img`,`c_desc`,`c_value`,`c_title`,`status`,`cdate`,`ctitle`,`min_amt`,`created_by`)values('".$url."','".$cdesc."','".$cvalue."','".$ccode."',".$cstatus.",'".$cdate."','".$ctitle."',".$minamt.",".$admin_id.")");
?>
