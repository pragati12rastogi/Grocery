						...
						<form class="form" method="post" enctype="multipart/form-data">
							<div class="form-body">
                                ...
                                <div class="form-group">
									...
									<input type="text" id="cpass" class="form-control"  name="password" value="<?php echo $getkey['password'];?>" required >
								</div>
...
$con->query("update admin set username='".$username."',password='".$password."',email='".$email."' where id=1");
