...
<body data-col="2-columns" class=" 2-columns ">
    <div class="layer"></div>
        ...
        <?php 
            ...
            if($username != 'admin' && $check_menu_notifi['view_g'] !=1 && $check_menu_notifi['view_o'] !=1 ){
        ?>
            <script>
            ...
            <div class="content-wrapper"><!--Statistics cards Starts-->
                <section id="dom">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1">
                                            <a href="export/notification_list.php?export=1"><button type="button" class="btn btn-outline-github btn-sm">Export</button></a>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                if($username == 'admin' || $check_menu_notifi['view_g'] ==1){
                                                  $sel = $con->query("select * from template order by id desc");
                                                    ...
                                                    $sel = $con->query("select * from template where created_by =".$admin_id." order by id desc");
                                                }
                    ...
                    background: transparent;"><i class="ft-bell font-medium-3"></i></button>
                                    ...
                                    <?php if($username == 'admin'|| $check_menu_notifi['edit'] ==1){ ?>
                									
                									  <a class="primary"  href="template.php?edit=<?php echo $row['id'];?>" data-original-title="" title="">
                                                            <i class="ft-edit font-medium-3"></i>
                                                        </a>
                										&nbsp;&nbsp;
                                    <?php } if($username == 'admin'|| $check_menu_notifi['delete'] ==1){ ?>   
                ...
                <?php 
                    if(isset($_GET['dele']))
                    {
                      if($username != 'admin'&& $check_menu_notifi['delete'] != 1){
                ...
                <?php
                    if(isset($_POST['nid']))
                    {
                        ...
                        if (isset($response->errors)) { 
                            echo '<script> toastr.options.timeOut = 4500; toastr.info("Error Occured : '.$response->errors[0].'"); </script>';
                            exit();
                        }
                        print_r($response->errors[0]);die("@test");
                		curl_close($ch);
