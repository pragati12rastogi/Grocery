      ...
      <div class="main-panel">
        <div class="main-content">
          <div class="content-wrapper"><!--Statistics cards Starts-->
            <div class="tab">
              <a href="order.php" ><button id="pending" type="button" class=" btn btn-outline-bitbucket ">Pending Orders</button></a>
              <a href="orders.php" ><button id="complete" type="button" class="= btn btn-outline-bitbucket">Completed Orders</button></a>
              <a href="excel.php" ><button id="export" type="button" class="active btn btn-bitbucket">Export</button></a>
                        ...
                        <table class="table table-striped" id="example">
                            ...
                            <tbody>
                                ...
                                if($username == 'admin' || $check_menu_order['view_g'] ==1){
                                    ...
                                    $sel = $con->query("select * from orders where status ='".$status."' and created_by =".$admin_id." and order_date >='".$start_date."' and order_date <='".$end_date."' order by id desc");
                                ...
                                while($row = $sel->fetch_assoc())
                                {
                                    ...
                                    $dc = $con->query("select * from area_db where id='".$user['area_id']."'")->fetch_assoc();
                                ...
                                <tr>
                                    ...
                                    <td><?php echo isset($add)?$add['hno'].','.$add['society'].','.$add['landmark'].','.$add['area'].'-'.$add['pincode']:'';?></td>
