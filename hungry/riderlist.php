<?php 
  ...
  <body data-col="2-columns" class=" 2-columns ">
    ...
    <div class="wrapper">
      ...
      if($username != 'admin' && $check_menu_dboy['view_g'] !=1 && $check_menu_dboy['view_o'] !=1 ){
        ?>
            <script>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                              <div class="row">
                                  <div class="col-md-11">
                                    <h4 class="card-title ml-1">Delivery Boy List</h4>
                                  </div>
                                  <div class="col-md-1">
                                      <a href="export/delivery_boy_list.php?export=1"><button type="button" class="btn btn-outline-github btn-sm">Export</button></a>
                                  </div>
                              </div>
                            </div>
                                    ...
                                    <table class="table table-striped table-bordered dom-jQuery-events">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                $ad = $con->query("select * from area_db where id=".$rkl['area_id']."")->fetch_assoc();
                                                echo $ad['name'];?></td>
                                                ...
                                                <td>
                                                  ...
                                                  <?php if($username == 'admin'|| $check_menu_dboy['edit'] ==1){
                                                    if($rkl['status'] == 0) { ?>
                                                  <a href="?status=1&rid=<?php echo $rkl['id'];?>">
                                                    <button class="btn btn-success"   data-original-title="" title="">
                                                                          Make Active
                                                    </button></a>
                                                  <?php } else { ?>
                                                <a	href="?status=0&rid=<?php echo $rkl['id'];?>">	<button class="btn btn-danger"  href="?status=0&rid=<?php echo $rkl['id'];?>" data-original-title="" title="">
                                                  ...
                                                  <td>
                                                <?php if($username == 'admin'|| $check_menu_dboy['edit'] ==1){ ?>
                                                <a class="primary"  href="add_rider.php?edit=<?php echo $rkl['id'];?>" data-original-title="" title="">
                                                    <i class="ft-edit font-medium-3"></i>
                                                </a>
                                                <?php } if($username == 'admin'|| $check_menu_dboy['delete'] ==1){ ?>   
...
if(isset($_GET['dele']))
{
  if($username != 'admin'&& $check_menu_dboy['delete'] != 1){
    header('Location: 404.php'); 
    die("404 error");
  }
