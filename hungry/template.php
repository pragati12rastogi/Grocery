            ...
            <div class="main-panel">
                <div class="main-content">
                    ...
                    <?php if(isset($_GET['edit'])) {
                        if($username != 'admin' && $check_menu_notifi['edit'] !=1 ){
	                ?>
                		<script>
									...
									<div class="card-body">
										<div class="px-3">
											...
											<?php 
												...
												$con->query("update template set message='".$msg."',title='".$title."',created_by=".$admin_id." where id=".$_GET['edit'].""); 
                    ...
                    <?php } else { 
                	if($username != 'admin' && $check_menu_notifi['create'] !=1 ){?>
                		<script>
                			window.location.href="404.php";
                		</script>
                	<?php	}	
                			...
                			<div class="card">
                				...
                				<div class="card-body">
                					<div class="px-3">
										...
										$con->query("insert into template(`message`,`url`,`title`,`created_by`)values('".$msg."','".$url."','".$title."',".$admin_id.")");
