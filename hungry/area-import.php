          ...
          if($ext === 'csv' || $ext === 'xlsx'){
            ...
            if(($handle = fopen($tmpName, 'r')) !== FALSE) {
                ...
                while(($data = fgetcsv($handle, 1000, ',')) !== FALSE) {
                        ...
                        $counts = $con->query("select * from area_db where name='".$data[0]."'")->num_rows;
                      ...
                      if($error == ''){
                        ...
                        else 
                        {
                            ...
                            $con->query("INSERT INTO `area_db`(`name`, `dcharge`, `verfication_status`, `status`, `created_by`) VALUES ('".$data[0]."','0','1','1',".$admin_id.")");
                        }
                      }else{
                        $con->rollback();
                      }
