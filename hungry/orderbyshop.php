        ...
        <div class="main-panel">
            <div class="main-content">
                <div class="content-wrapper"><!--Statistics cards Starts-->
                    ...
                    <a href="orderbyshop.php" ><button id="shop" type="button" class="active btn btn-bitbucket">Shop Orders</button></a>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Shop Orders List</h4>
                                </div>
                                        ...
                                        <table class="table table-striped" id="example">
                                            ...
                                            <tbody>
                                                ...
                                                if($username == 'admin' || $check_menu_order['view_g'] ==1){
                                                    $sel = $con->query("select * from orders where status ='completed' and order_type ='store' order by id desc");
                                                }else{
                                                    $sel = $con->query("select * from orders where status ='completed' and order_type ='store' and created_by =".$admin_id." order by id desc");
                                                }
